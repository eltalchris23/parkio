...
Los módulos Rol, Estacionamiento y Cajón cuentan con API REST, validaciones declarativas, servicios transaccionales, mappers y pruebas unitarias. El manejo global de excepciones está implementado. Los flujos de autenticación y Usuario continúan como arquitectura objetivo.
